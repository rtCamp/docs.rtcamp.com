...
**media_author**
The id of the author of the media. This has the same value as **post_author** for the **media_id** in the WordPress **posts** table.
In short, this will be always set to the logged in user who is uploading media from the web-interface.

**media_title**
The title for the media. This has the same value as **post_title** for the **media_id** in the WordPress **wp_posts** table.
...
* `media_id` The id from the _wp_rtm_media table_
...
* `id` The unique id for indexing.
* `user_id` The id of the user.
* `media_id` The id from the _wp_rtm_media_ table.
* `action` This could  be a Like, Rating, or View.
* `value` The value related to the action.
* `action_date` The timestamp of the action.
